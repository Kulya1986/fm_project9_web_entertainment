  ...
  return (
    <nav>
      <div id="menu">
        ...
        <ul id="menu-tabs">
          <li id="menu-tabs-home" onClick={handlePageChange}>
            <NavLink to="/">
          ...
          <li id="menu-tabs-movies" onClick={handlePageChange}>
            <NavLink to="/movies">
              <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li id="menu-tabs-tv-series" onClick={handlePageChange}>
          ...
          <li id="menu-tabs-bookmark" onClick={handlePageChange}>
